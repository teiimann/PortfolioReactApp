    ...
    <StyledWrapper>
      <div className="card">
        ...
        <form className="card__form">
                <InputContacts label="Name"/>
                <InputContacts label="Email"/>
                <InputContacts label="Message"/>
                
          <button className="card__button"  onClick={onNext}>Click me</button>
        </form>
      </div>
    </StyledWrapper>
  );
